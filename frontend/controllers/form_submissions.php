...
class FMControllerForm_submissions {
  ...
  public function __construct() {
    require_once WDFM()->plugin_dir . "/frontend/models/form_submissions.php";
    $this->model = new FMModelForm_submissions();

    require_once WDFM()->plugin_dir . "/frontend/views/form_submissions.php";
  ...
  public function frontend_show_map() {
    $long = WDW_FM_Library::get('long', 0);
    $lat = WDW_FM_Library::get('lat', 0);
  ...
  public function frontend_show_matrix() {
    $matrix_params = WDW_FM_Library::get('matrix_params', '');
  ...
  public function frontend_paypal_info() {
    $submission_id = (int) WDW_FM_Library::get('id', 0);
